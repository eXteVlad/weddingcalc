...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["jquery-1.8.3.min.js", "museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "require.js", "services.css"], "outOfDate":[]};
</script>
  
  <title>Услуги</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="css/site_global.css?crc=3916556066"/>
  <link rel="stylesheet" type="text/css" href="css/master_______-a.css?crc=3964397231"/>
  <link rel="stylesheet" type="text/css" href="css/services.css?crc=247344741" id="pagesheet"/>
  <!-- JS includes -->
  <!--[if lt IE 9]>
       ...
       <div class="clearfix colelem" id="u458"><!-- group -->
        <nav class="MenuBar clearfix grpelem" id="menuu459"><!-- horizontal box -->
         ...
         <div class="MenuItemContainer clearfix grpelem" id="u672"><!-- vertical box -->
          <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive transition clearfix colelem" id="u673" href="services.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap transition clearfix grpelem" id="u674-4"><!-- content --><p>Услуги</p></div></a>
         </div>
