...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["jquery-1.8.3.min.js", "museutils.js", "museconfig.js", "jquery.musemenu.js", "jquery.watch.js", "require.js", "analysis.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/analysis.css?crc=82851230" id="pagesheet"/>
  <!-- JS includes -->
  <!--[if lt IE 9]>
       ...
       <div class="clearfix colelem" id="u458"><!-- group -->
        <nav class="MenuBar clearfix grpelem" id="menuu459"><!-- horizontal box -->
         ...
         <div class="MenuItemContainer clearfix grpelem" id="u474"><!-- vertical box -->
          <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive transition clearfix colelem" id="u477" href="analysis.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap transition clearfix grpelem" id="u478-4"><!-- content --><p>Анализ</p></div></a>
         </div>
